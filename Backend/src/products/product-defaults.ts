/** Defaults aligned with storefront `ProductDetail` when DB fields are empty. */
...
export const DEFAULT_PRODUCT_SPECIFICATIONS: string[] = [
...
export const DEFAULT_PRODUCT_SIZES: string[] = ['S', 'M', 'L', 'XL', 'XXL'];
